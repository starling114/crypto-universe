<template>
  ...
  <div class="mb-2">
    <cu-label name="profiles" label="Profiles"
      tooltip="Rabby password. All profiles should have the same rabby password." />
  ...
  <cu-input name="password" v-model="password" label="Rabby password" tooltip="" placeholder="Enter password..." />
