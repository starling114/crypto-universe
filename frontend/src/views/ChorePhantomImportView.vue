...
import { loadModuleData, stopModule, updateModuleData, startModule, beforeUnloadModule, beforeRouteLeaveModule, loadBrowserProfiles } from '@/utils'
...
const loadDefaults = async () => {
  await loadBrowserProfiles(proxy, (profiles) => {
